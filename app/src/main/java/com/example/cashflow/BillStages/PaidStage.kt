...
class PaidStage: BillState {
    ...
    override fun getBillView(): Class<out AppCompatActivity> {
        return PaidBillViewActivity::class.java
    }
}
class PaidBillViewActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        setContentView(R.layout.activity_paid_bill_view)

...
class UrgentProcessingStage:BillState{
    ...
    override fun getBillView(): Class<out AppCompatActivity> {
        ...
        return UrgentProcessingBillViewActivity::class.java
    }
}

class UrgentProcessingBillViewActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        setContentView(R.layout.activity_urgent_processing_bill_view)
        ...
        confirmBtn = findViewById(R.id.paid_btn)

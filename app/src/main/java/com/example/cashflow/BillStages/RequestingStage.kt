...
class RequestingStage : BillState {
...
class RequestingBillViewActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        setContentView(R.layout.activity_requesting_bill_view)
        ...
        // Ensure bill is retrieved correctly from the intent

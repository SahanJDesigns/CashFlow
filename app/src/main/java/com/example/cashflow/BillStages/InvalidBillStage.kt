...
class InvalidBillStage(override val id: Int) : BillState {
    ...
    override fun getBillView(): Class<out AppCompatActivity> {
        ...
        return InvalidBillViewActivity::class.java
    }
}
class InvalidBillViewActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        setContentView(R.layout.activity_invalid_bill_view)
